...
const config = {
    root: "app",
    get sassFiles() {
        return `${this.root}/sass/*.scss`;
    },
    get jsFiles() {
        return `${this.root}/js/*.js`;
    },
    get pugFiles() {
        return `${this.root}/*.pug`;
    },
    get staticFiles() {
...
function static() {
    return src(config.staticFiles).pipe(dest("public/"));
}
...
exports.css = css;
exports.html = html;
exports.dev = series(watchFiles, parallel(html, css, js, static), serve);
